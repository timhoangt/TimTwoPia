...
//
const APP_NAME: string    = "Timotopia";   // 'cause Bob and I were at a loss for a better name.
const APP_VERSION: string = "0.04";   // What did you expect?
...
var _KernelError: boolean = false;  // initilizing to false.
